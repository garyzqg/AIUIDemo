...
public final class ToastUtil {
    ...
    public final ToastUtil setLeftIcon(@DrawableRes int resId) {
        return setLeftIcon(ContextCompat.getDrawable(InitUtil.getAppContext(), resId));
    }
    ...
    public final ToastUtil setTopIcon(@DrawableRes int resId) {
        return setTopIcon(ContextCompat.getDrawable(InitUtil.getAppContext(), resId));
    }
    ...
    public final ToastUtil setRightIcon(@DrawableRes int resId) {
        return setRightIcon(ContextCompat.getDrawable(InitUtil.getAppContext(), resId));
    }
    ...
    public final ToastUtil setBottomIcon(int resId) {
        return setBottomIcon(ContextCompat.getDrawable(InitUtil.getAppContext(), resId));
    }
    ...
    public final void show(@StringRes final int resId) {
        show(InitUtil.getString(resId), getDuration(), this);
    }
    ...
    private View tryApplyUtilsToastView(final CharSequence text) {
        ...
        View toastView = ViewUtil.layoutId2View(R.layout.view_toast_util);
    ...
    public static void showShort(@StringRes final int resId) {
        show(InitUtil.getString(resId), Toast.LENGTH_SHORT, DEFAULT_MAKER);
    }
    ...
    public static void showLong(@StringRes final int resId) {
        show(InitUtil.getString(resId), Toast.LENGTH_LONG, DEFAULT_MAKER);
    }
    ...
    private static IToast newToast(ToastUtil toastUtils) {
        if (!toastUtils.isNotUseSystemToast) {
            if (NotificationManagerCompat.from(InitUtil.getAppContext()).areNotificationsEnabled()) {
        ...
        } else if (PermissionUtil.isGrantedDrawOverlays()) {
    ...
    static final class WindowManagerToast extends AbsToast {
        ...
        WindowManagerToast(ToastUtil toastUtils, int type) {
            ...
            mWM = (WindowManager) InitUtil.getAppContext().getSystemService(Context.WINDOW_SERVICE);
            mParams.type = type;
        }
        ...
        public void show(final int duration) {
            ...
            mParams.packageName = InitUtil.getAppContext().getPackageName();
    ...
    static final class ActivityToast extends AbsToast {
        ...
        public void cancel() {
            for (Activity activity : ActivityManager.getInstance().getActivityList()) {
                if (!ActivityManager.isActivityAlive(activity)) {
                    continue;
                }
        ...
        private void showWithActivityView(final Activity activity, final int index, boolean useAnim) {
            ...
            if (window != null) {
                ...
                lp.bottomMargin = mToast.getYOffset() + ViewUtil.getNavBarHeight();
                lp.topMargin = mToast.getYOffset() + ViewUtil.getStatusBarHeight();
    ...
    static abstract class AbsToast implements IToast {
        ...
        AbsToast(ToastUtil toastUtils) {
            mToast = new Toast(InitUtil.getAppContext());
        ...
        public void setToastView(CharSequence text) {
            ...
            if (mToastView == null || mToastView.findViewById(android.R.id.message) == null) {
                setToastView(ViewUtil.layoutId2View(R.layout.view_toast_util));
            }
        ...
        View getToastViewSnapshot(final int index) {
            Bitmap bitmap = ViewUtil.view2Bitmap(mToastView);
            ImageView toastIv = new ImageView(InitUtil.getAppContext());
    ...
    public static final class UtilsMaxWidthRelativeLayout extends RelativeLayout {
        ...
        private static final int SPACING = ViewUtil.dp2px(80);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int widthMaxSpec = MeasureSpec.makeMeasureSpec(ViewUtil.getAppScreenWidth() - SPACING, MeasureSpec.AT_MOST);
